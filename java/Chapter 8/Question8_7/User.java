...
public class User {
	...
	private HashMap<Integer, PrivateChat> privateChats = new HashMap<Integer, PrivateChat>();//use the id as the retrieval
	...
	public boolean sendMessageToUser(User toUser, String content) {
		PrivateChat chat = privateChats.get(toUser.getId());//use the id as the retrieval, identifier, chat
		if (chat == null) {
	...
	public void receivedAddRequest(AddRequest req) {
		...
		if (!receivedAddRequests.containsKey(senderId)) {//avoid redundant
