package Question4_9_FindSumPath;
...
public class Question {
	...
	public static void findSum(TreeNode node, int sum, int[] path, int level) {
		...
		int t = 0;
		// done how to start anywhere.
		// Print backward, that is how it is done to start from any where
		 ...
		 * ignore this value, but it's good practice01.
		 */
