...
public class QuestionTest {
    ...
    public void testNthToLastR1_1() throws Exception {
        ...
        assertEquals(10, Question.nthToLastR1(head, nth));
    }
    ...
    public void nthToLastR2_3() throws Exception {
        ...
        int nth = 3;
        assertEquals(3, Question.size(Question.nthToLastR2Interface(head, nth)));
    }
    ...
    public void NthToLastR3Helper_4() throws Exception {
        ...
        System.out.println(head.printForward());
        int nth = 3;
        assertEquals(3, Question.size(Question.nthToLastR3(head, nth)));
    }
    ...
    public void testNthToLastR3_6_TheNIsTooBig() throws Exception {
        ...
        System.out.println(head.printForward());
        int nth = 23;
        assertEquals(null, Question.nthToLastR3(head, nth));
    }
    ...
    public void testNthToLastR3_8_NullNode() throws Exception {
        int nth = 3;
        assertEquals(0, Question.size(Question.nthToLastR3(null, nth)));
    }
