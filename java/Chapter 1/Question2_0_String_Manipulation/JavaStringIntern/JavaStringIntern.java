package Question2_0_String_Manipulation.JavaStringIntern;

/**
 * Created by SiyuanZeng's on 6/2/2016.
 */
public class JavaStringIntern {
    public static void main(String[] args) {
        ...
        String str6 = new String("JavaCodeGeeks").intern();
        ...
        System.out.println("Are str1 and str5 the same: " + (str1 == str5));// true
        System.out.println("Are str1 and str5 the same: " + (str6 == str5));// true
        System.out.println("Are str4 and str5 the same: " + (str4 == str5));// false
    }
}
